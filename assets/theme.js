(function (factory) {
  ...
  var ProductVariants = /*#__PURE__*/function () {
    function ProductVariants(container, options) {
      ...
      this._VariantsImages(this.currentVariant);
      this._attachListeners();
    ...
    _createClass(ProductVariants, [{
      ...
      value: function _onVariantChanged(previousVariant, newVariant) {
        ...
        this._VariantsImages(newVariant);
       ...
       */
         ...
         {
  key: "_VariantsImages",
      value: function _VariantsImages(newVariant) {
        if (!newVariant) {
          return;
        }
        if(newVariant.title != 'Default Title' ){
          console.log(window.theme.ImagesLogic);
   var variantAlt = newVariant.featured_image.alt
   var varaintImage = newVariant.featured_image
  ...
  var CollectionSection = /*#__PURE__*/function () {
    function CollectionSection(element) {
      ...
      this.timeline = new TimelineLite({
        delay: window.theme.showPageTransition ? 0.9 : 0
      });
    ...
    _createClass(FeaturedCollectionsSection, [{
      ...
      value: function _setupAnimation() {
        ...
        if (this.options['layout'] === 'grid' && window.theme.showElementStaggering) {
          ...
          if (productList) {
            this.timeline.fromTo(productList, 0.3, {
              autoAlpha: 0,
              y: 10
            }, {
              autoAlpha: 1,
...
if($('body').attr('data-off') != '' & $('body').attr('data-off') != undefined){
setTimeout(function(){
  $('.bsub-widget__group-discount-summary').text($('body').attr('data-off'));
},4000)
}
// if($('body').attr('data-title') == 'FLYGRUBS-5LB'){
// setTimeout(function(){
//  $('<span class="bsub-widget__group-discount-summary">(20% off)</span>').insertAfter('.bsub-widget__group-label input[value="once"]+.bsub-widget__group-header .bsub-widget__text');
// },4000)
// }